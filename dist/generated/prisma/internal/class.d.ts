 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.ordersProduct`: Exposes CRUD operations for the **OrdersProduct** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more OrdersProducts
      * const ordersProducts = await prisma.ordersProduct.findMany()
      * ```
      */
    get ordersProduct(): Prisma.OrdersProductDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.claims`: Exposes CRUD operations for the **Claims** model.
      ...
      * ```
      */
    get claims(): Prisma.ClaimsDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
